...
final String appsFlyerDevKey = "5BuX8ZX9TbmipMXFUL8255";
final String serverUrl = "https://yieldcraft.digital/goldenbloom-tech";
final String appName = 'RabRoadIOS';
final String bundleId = 'com.raabbitrrooaddd';
final String appId = '6752644608';
...
class _GameTimerState extends State<GameTimer> {
  ...
  static const platform = MethodChannel('com.raabbitrrooaddd/deeplink');
  ...
  Future<void> _setupCustomDeepLinkHandling() async {
    try {
      ...
      if (initialLink != null && initialLink.startsWith('rabroadd://')) {
  ...
  Future<void> _fetchAppleSearchAdsData() async {
    try {
      final String? appleSearchAdsToken = await FlutterAsaAttribution.instance
          .attributionToken();
